<x-admin-layout>
    <div class="max-w-3xl mx-auto space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-serif font-bold text-foreground">Edit Category</h1>
                <p class="text-muted-foreground font-medium">Update the taxonomy details.</p>
            </div>
        </div>
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" 
                        class="block w-full border-border bg-secondary/30 rounded-2xl focus:ring-primary focus:border-primary px-4 py-3" 
                        placeholder="Explain what this category covers...">{{ old('description', $category->description) }}</textarea>
