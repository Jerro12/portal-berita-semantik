...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Semantic Index - NewsHub Knowledge Base</title>
        ...
        <nav class="border-b border-border bg-background/80 backdrop-blur-md py-4 sticky top-0 z-50">
            <div class="max-w-5xl mx-auto px-4 flex justify-between items-center">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <a href="{{ route('public.semantic.index') }}" class="text-xs font-bold text-primary uppercase tracking-widest">Semantic Index</a>
                </div>
            </div>
        </nav>
        ...
        <main class="max-w-5xl mx-auto px-4 py-16">
            <div class="space-y-12">
                <header class="text-center space-y-4">
                    <h1 class="text-4xl font-serif font-bold">Semantic Knowledge Index</h1>
                    <p class="text-muted-foreground max-w-2xl mx-auto">Real-time statistics and exploration of the persistent triplestore knowledge graph.</p>
                </header>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="p-8 bg-background border border-border rounded-[2rem] shadow-sm flex flex-col items-center text-center">
                        ...
                        <div class="text-xs font-bold uppercase tracking-widest text-muted-foreground">Unique Predicates</div>
                    </div>

                    <div class="p-8 bg-background border border-border rounded-[2rem] shadow-sm flex flex-col items-center text-center">
                        <div class="text-5xl font-serif font-bold mb-2 text-foreground">{{ \App\Models\News::count() }}</div>
                        <div class="text-xs font-bold uppercase tracking-widest text-muted-foreground">Indexed Articles</div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div class="bg-background border border-border rounded-[2rem] overflow-hidden shadow-sm">
                        <div class="p-6 bg-secondary/10 border-b border-border">
                            <h3 class="font-bold font-serif text-lg">Predicate Usage Distribution</h3>
                        </div>
                        <div class="p-6">
                            <div class="space-y-6">
                                @foreach($predicates as $row)
                                    <div class="space-y-2">
                                        <div class="flex justify-between items-end">
                                            ...
                                            <span class="text-[10px] font-bold text-muted-foreground">{{ $row['count'] }} uses</span>
                                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="p-8 bg-secondary/30 rounded-[2rem] border border-border">
                            <h3 class="font-bold font-serif text-xl mb-4">Semantic Engine Info</h3>
                        ...
                        <div class="p-8 border border-primary/20 bg-primary/5 rounded-[2rem]">
                            <h3 class="font-bold font-serif text-lg text-primary mb-3">Interoperability Notice</h3>
